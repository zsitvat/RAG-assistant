...
- [x] Generation observations record model, prompt identity/version, token usage, and latency so performance bottlenecks can be attributed to individual calls.
